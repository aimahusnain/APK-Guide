...
const stroage = getStorage(app, "gs://nextjs-blog2-15b36.appspot.com");
...
export default function Create() {
  ...
  const [selectedSection, setSelectedSection] = useState<string>("blog"); // Default to 'blog'
  ...
  async function handleSaveBlogPost() {
    ...
    const res = await fetch(`/api/${selectedSection}-post/add-post`, {
      method: "POST",
      headers: {
